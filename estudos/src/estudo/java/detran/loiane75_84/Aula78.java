...
public class Aula78 {
	...
	public static void main(String[] args) {
		...
		System.out.println("ola equals ola2 " + ola.equalsIgnoreCase(ola3)); //true, não importa maiúsculas e menusculas, e nem acentuações
		
		System.out.println("ola == ola1 " + (ola == ola2)); // false
//		System.out.println("ola == ola3 " + (ola == ola4)); // true, está comparando o endereço na memoria
		System.out.println("ola == ola3 " + (ola == ola4)); // false
		System.out.println("ola equals ola4 = " + ola.equals(ola4));// true, está comparando o endereço na memoria
